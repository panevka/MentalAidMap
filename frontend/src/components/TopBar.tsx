  ...
  return (
    <header className="flex bg-[#2B3A67] h-16 md:h-20 p-2 justify-center md:py-10">
      <div className="flex flex-row justify-between h-full w-full">
        ...
        <Navigation navClassName="hidden md:flex lg:w-3/5 md:mx-5" ulClassName="text-[#FAF9F6] md:text-sm md:text-center lg:text-xl md:font-medium uppercase font-inter flex w-full flex-row justify-around items-center" liClassName="md:mx-4 group transition-all duration-300 ease-in-out" linkClassName="bg-bottom bg-gradient-to-r from-white to-white bg-[length:0%_1px] bg-no-repeat group-hover:bg-[length:100%_1px] transition-all duration-500 ease-out" />
